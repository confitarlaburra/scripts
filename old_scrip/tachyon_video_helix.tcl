...
#nanotube 1 
  ...
  mol modstyle    0 top licorice 0.1500000 50.000000 50.000000 
...
#water inside nt1
  ...
  mol modstyle    1 top VDW 1.000000 99.000000
  mol modcolor    1 top colorid 23
  mol modmaterial 1 top Diffuse
#nanotube 2 
  mol addrep top
  mol modselect   2 top segid NT2 
  mol modstyle    2 top licorice 0.1500000 50.000000 50.000000 
...
#nanotube 4 
  ...
  mol modstyle    5 top licorice 0.1500000 50.000000 50.000000 
  mol modcolor    5 top colorid 6
  mol modmaterial 5 top Diffuse	
#water
  mol addrep top
  mol modselect   6 top water and (z < -18 or  water and z >18) and y < 13
  mol modstyle    6 top VDW 1.000000 99.000000
...
# done with molecule 0
  foreach v $viewplist {
     molinfo top set {center_matrix rotate_matrix scale_matrix global_matrix} $viewpoints($v)
  }
  ...
  if { $frame >= 10 && $frame <= 99 } {
     ...
     exec /usr/local/lib/vmd/tachyon_LINUXAMD64 -auto_skylight 1.3 00$frame.dat -o 00$frame.tga -aasamples 8
  ...
  if { $frame >= 100 && $frame <= 999 } {
     ...
     exec /usr/local/lib/vmd/tachyon_LINUXAMD64  -auto_skylight 1.3 0$frame.dat -o 0$frame.tga -aasamples 8
