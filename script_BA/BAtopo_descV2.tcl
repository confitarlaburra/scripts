...
#Input PSF
set psf  3DOXlagoUCA_ch.box.ion.psf
#Number of input dcd
set firstDCD 3
set lastDCD  3
set steps 0
...
set names(CA)  {C2 C17 C14}
set names(O3)  {C2 C10 C17 C19}
set names(O7)  {O3 C15 C11 H18}
set names(O12) {O4 C16 C12 H19}
set names(H14) {H18 C11 C14 C1}
set names(DHO) {H18 C1}
