...
#Input PSF
set psf   ../HV1.POPC.Wat.box.ion.ModelIR.psf
#set reference_pdb  ../HV1.POPC.Wat.box.ion.ModelIR.pdb
set reference_pdb  ../ANA/cluster0.35/01.874.0.0.pdb

set outname RMSD_RGYR_SASA.vs.Clust.dat
